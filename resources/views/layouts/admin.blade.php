...
<body class="h-screen w-screen flex overflow-hidden bg-gray-50">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-64 bg-[#0B2240] text-white flex flex-col transform -translate-x-full md:translate-x-0 md:relative md:inset-auto transition-transform duration-300 shadow-xl flex-shrink-0">
        <!-- Logo -->
        <div class="h-16 flex items-center justify-between px-5 border-b border-navy-800 bg-[#061c3f] flex-shrink-0">
            <a href="/" class="flex items-center gap-2 hover:opacity-90 transition-opacity" title="Bosh sahifa">
                ...
                <span class="text-[#0084ff] text-[10px] font-black uppercase tracking-wider bg-blue-500/20 px-2 py-0.5 rounded border border-blue-500/30">ADMIN</span>
            </a>
