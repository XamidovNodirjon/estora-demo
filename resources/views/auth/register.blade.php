...
<body class="min-h-screen flex items-center justify-center p-3.5 sm:p-6 py-6 sm:py-12 overflow-x-hidden">
    ...
    <div class="w-full max-w-lg mx-auto">
        ...
        @if(session('info'))
            <div class="mb-4 sm:mb-5 p-3.5 sm:p-4 rounded-xl sm:rounded-2xl bg-blue-500/20 border border-blue-500/40 text-blue-200 flex items-start gap-2.5 sm:gap-3 shadow-lg text-xs sm:text-sm animate-fade-in backdrop-blur-md">
                <i class="fa-solid fa-circle-info text-lg sm:text-xl text-blue-400 flex-shrink-0 mt-0.5"></i>
                <div class="space-y-1">
        ...
        <!-- Register Card -->
        <div class="glass-card rounded-2xl sm:rounded-3xl p-4 sm:p-7 shadow-2xl w-full">
            <h2 class="font-display font-bold text-xl sm:text-2xl text-white text-center mb-1.5">Yangi hisob yaratish</h2>
            <p class="text-center text-xs text-gray-400 mb-4 sm:mb-6">O'zingizga mos ro'yxatdan o'tish turini tanlang</p>
            ...
            <!-- Errors -->
            @if ($errors->any())
                <div class="mb-4 sm:mb-6 p-3 sm:p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-red-200">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-3.5 sm:space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 sm:pl-3.5 flex items-center text-gray-400 text-xs sm:text-sm pointer-events-none">
                ...
                <!-- Submit Button -->
                <button type="submit"
                    class="w-full py-3 px-4 mt-3 sm:mt-4 rounded-xl bg-[#0084ff] hover:bg-[#0076e5] text-white font-bold text-xs sm:text-sm transition-all shadow-lg hover:shadow-cyan-500/25 active:scale-[0.99] cursor-pointer">
                    Ro'yxatdan o'tish
                </button>
            </form>
