    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <!-- O'chirish tugmasi -->
                                        <button type="button" onclick="openDeleteModal('{{ route('admin.metros.delete', $metro->id) }}', 'Ushbu bekatni rostdan ham o\'chirmoqchimisiz?')" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="O'chirish">
        ...
        <div>
            <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <form action="{{ route('admin.metros.store') }}" method="POST" class="space-y-4">
                    @csrf
                    <div>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <!-- O'chirish tugmasi -->
                                        <button type="button" onclick="openDeleteModal('{{ route('admin.universities.delete', $university->id) }}', 'Ushbu universitetni rostdan ham o\'chirmoqchimisiz?')" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="O'chirish">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button>
                                    </div>
                                </td>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <!-- O'chirish tugmasi -->
                                        <button type="button" onclick="openDeleteModal('{{ route('admin.product-items.delete', $item->id) }}', 'Ushbu imkoniyatni rostdan ham o\'chirmoqchimisiz?')" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="O'chirish">
                                            <i class="fa-solid fa-trash-can"></i>
                                        </button>
                                    </div>
                                </td>
        ...
        <div>
            <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <form action="{{ route('admin.product-items.store') }}" method="POST" class="space-y-4">
                    @csrf
                    <div>
