...
class DeveloperProductItemController extends Controller
{
    ...
    public function store(ProductItemRequest $request)
    {
        ...
        return redirect()->route('developer.infrastructure')->with('success', 'Qo\'shimcha imkoniyat muvaffaqiyatli yaratildi!');
    }
    ...
    public function update(ProductItemRequest $request, ProductItem $productItem)
    {
        ...
        return redirect()->route('developer.infrastructure')->with('success', 'Qo\'shimcha imkoniyat muvaffaqiyatli yangilandi!');
    }

    public function destroy(ProductItem $productItem)
    {
        $this->service->deleteProductItem($productItem);
        return redirect()->route('developer.infrastructure')->with('success', 'Qo\'shimcha imkoniyat o\'chirildi!');
    }
}
