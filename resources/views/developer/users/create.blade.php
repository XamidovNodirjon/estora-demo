...
@section('header_title', 'Foydalanuvchi Yaratish')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
        ...
        <div>
            <h2 class="font-display font-bold text-lg text-[#061c3f]">Universal Foydalanuvchi Yaratish</h2>
            <p class="text-xs text-gray-400">Har qanday roldagi foydalanuvchini qo'lda yaratish formasi</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
        ...
        <form action="{{ route('developer.users.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type" id="type"
                        ...
                        <option value="admin" {{ old('type') == 'admin' ? 'selected' : '' }}>Admin (Admin/Staff)</option>
                        <option value="manager" {{ old('type') == 'manager' ? 'selected' : '' }}>Manager (Admin/Staff)</option>
