                    ...
                    <div>
                        ...
                        <select name="metros[]" id="metros" multiple size="4"
                            ...
                            @foreach($metros as $metro)
                                <option value="{{ $metro->id }}" {{ is_array(old('metros', $selectedMetros)) && in_array($metro->id, old('metros', $selectedMetros)) ? 'selected' : '' }}>
                                    {{ $metro->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="universities[]" id="universities" multiple size="4"
                            ...
                            @foreach($universities as $university)
                                <option value="{{ $university->id }}" {{ is_array(old('universities', $selectedUniversities)) && in_array($university->id, old('universities', $selectedUniversities)) ? 'selected' : '' }}>
                                    {{ $university->name }}
                                </option>
                            @endforeach
                        </select>
