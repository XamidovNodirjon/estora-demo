    ...
    <main class="w-full max-w-md mx-auto flex-1 flex flex-col justify-center animate-fade-in-up">
        ...
        <div class="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-xl">
            ...
            <div class="relative flex py-4 items-center">
                ...
                <span class="flex-shrink mx-4 text-xs text-slate-400 font-medium">Yoki</span>
                <div class="flex-grow border-t border-slate-200"></div>
            </div>

            <!-- Google OAuth Button -->
            <a href="{{ route('auth.google') }}"
                class="w-full py-3 px-4 rounded-2xl bg-white border border-slate-200 hover:border-blue-400 hover:shadow-md text-slate-700 font-bold text-xs sm:text-sm flex items-center justify-center gap-3 transition-all cursor-pointer">
